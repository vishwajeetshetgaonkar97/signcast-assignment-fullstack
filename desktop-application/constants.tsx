...
const BASE_URL_PROD = 'https://signcast-assignment-fullstack-production-32ab.up.railway.app';



const BASE_WEB_SOCKET_URL_TEST = 'ws://localhost:3003';
const BASE_WEB_SOCKET_URL_PROD = 'wss://signcast-assignment-fullstack-production-32ab.up.railway.app/';
