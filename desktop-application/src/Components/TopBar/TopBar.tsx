...
const TopBar: React.FC<TopBarProps> = ({ setThemeMode,setModalOpen, themeMode }) => {
  ...
  return (
    <div className="flex w-full h-[5%] justify-between  items-center dark:text-neutral-100 px-4 py-2">
      ...
      <div className="text-sm flex gap-2 flex-row items-center ">
        <div className="relative hover:bg-card-color rounded-sm p-2">
          {isMonitoring ? (
        ...
        <MdLogout onClick={handleLogout} size={20} className=" cursor-pointer text-red-500 hover:bg-card-color" />
      </div>
